      ...
      <PostItem data-id={props.id}>
        ...
        <TimeWrapper>
          ...
          <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10 18.75C14.8325 18.75 18.75 14.8325 18.75 10C18.75 5.16751 14.8325 1.25 10 1.25C5.16751 1.25 1.25 5.16751 1.25 10C1.25 14.8325 5.16751 18.75 10 18.75Z" stroke="#777777" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
